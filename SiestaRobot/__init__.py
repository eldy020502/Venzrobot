...
LOGGER.info("Venz is starting. | An Venz Project Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/eldy020502 (t.me/vnotv)")
